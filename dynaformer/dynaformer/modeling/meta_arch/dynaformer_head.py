...
from ..transformer_decoder.dynaformer_decoder import build_transformer_decoder
from ..pixel_decoder.dynaformer_encoder import build_pixel_decoder


@SEM_SEG_HEADS_REGISTRY.register()
class DYNAFormerHead(nn.Module):
    @configurable
    def __init__(
        self,

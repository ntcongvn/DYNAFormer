...
def build_pixel_decoder(cfg, input_shape):
    ...
    """
    name = cfg.MODEL.SEM_SEG_HEAD.PIXEL_DECODER_NAME                                      #DynAMFormerEncoder
...
class DYNAFormerEncoder(nn.Module):
    """
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["transformer_dropout"] = cfg.MODEL.DYNAFormer.DROPOUT                                                                       #0.0
        ret["transformer_nheads"] = cfg.MODEL.DYNAFormer.NHEADS                                                                         #8
